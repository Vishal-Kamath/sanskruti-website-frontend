...
import TableBody from "./tableRow";
      ...
      <Page size="A4">
        ...
        >
          ...
          >
            ...
            >
              ...
              <Text>{payment.billingAddress.name}</Text>
              <Text>{payment.billingAddress.email}</Text>
              <Text>{payment.billingAddress.tel}</Text>
            </View>
            <View
              style={{
                display: "flex",
        ...
        >
          ...
          {orders.map((order, index) => {
            const variantion = Object.values(order.product.varient.variations)
              .filter((val) => val)
              .join(", ");
            ...
            return (
              <TableBody
                ...
                contents={[
                  ...
                  {
                    title: `${order.product.varient.price}`,
                    width: 15,
                  },
                  {
                    title: order.product.quantity.toString(),
                    width: 10,
                  },
                  {
                    title: (
                      order.product.quantity * order.product.varient.price
                    ).toString(),
                    width: 20,
                  },
                ]}
          ...
          >
            <Text style={{ textAlign: "left" }}>Sub Total</Text>
            <Text>{payment.orderInfo.SubTotal}</Text>
          </View>
          <View
            style={{
              display: "flex",
          ...
          >
            <Text style={{ textAlign: "left" }}>Total GST</Text>
            <Text>{payment.orderInfo.TotalGST}</Text>
          </View>
          {payment.orderInfo.Totaldiscount && (
            <View
              style={{
                display: "flex",
                flexDirection: "row",
            ...
            >
              <Text style={{ textAlign: "left" }}>Total Discount</Text>
              <Text>{payment.orderInfo.Totaldiscount}</Text>
            </View>
          )}
          {payment.orderInfo.CouponCode && payment.orderInfo.CouponDiscount && (
            <View
              style={{
                display: "flex",
                flexDirection: "row",
            ...
            >
              <Text style={{ textAlign: "left" }}>Coupon Discount</Text>
              <Text>{payment.orderInfo.CouponDiscount}</Text>
            </View>
          )}
          <View
            style={{
        ...
        >
          © 2020 - 2023 Sanskruti NX All Rights Reserved.
        </Text>
      </Page>
    </Document>
  );
