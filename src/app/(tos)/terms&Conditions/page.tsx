  ...
  return (
    <div className="flex flex-col gap-5 px-[3vw] pb-10 pt-[117px] max-md:pt-32">
      ...
      <div className="text-md text-justify">
        ...
        to as &quot;Platform&quot;) The Platform is owned by Sanskruti Designs
        Private Limited, having its registered office at Buildings Alyssa,
        Begonia and Clover situated in Embassy Tech Village, Outer Ring Road,
        ...
        Use&quot;) as applicable to the Sanskruti including the applicable
        policies which are incorporated herein by way of reference. By mere use
        of the Sanskruti, You shall be contracting with Sanskruti Designs
        Private Limited, the owner of the Platform. These terms and conditions
        including the policies constitute Your binding obligations, with
        Sanskruti. For the purpose of these Terms of Use, wherever the context
        so requires &quot;You&quot; or &quot;User&quot; shall mean any natural
        or legal person who has agreed to become a buyer on Platform by
        providing data while registering on the Platform as Registered User. The
        term &quot;Sanskruti&quot;,&quot;We&quot;,&quot;Us&quot;,&quot;Our&quot;
        shall mean Sanskruti Designs Private Limited and its affiliates. When
